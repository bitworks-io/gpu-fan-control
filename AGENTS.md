...
For this project, the user explicitly authorizes Codex to use parallel sub-agents by default for non-trivial work when tasks can be split into independent research, implementation, testing, security, documentation, or release-readiness scopes. Keep one integrating owner, use bounded scopes, and avoid overlapping write areas.

- Use parallel agents when work can be split into independent research, architecture, implementation, testing, debugging, security, documentation, or release-readiness tasks.
